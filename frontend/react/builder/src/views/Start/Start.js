...
function Start(props) {
  return (
      <div className="layout_display_flex layout_direction_column layout_flex_full_size">
            ...
            <div className="header__container">
                ...
                <div className="mobile_hidden">
                    <Button 
                        ...
                        iconClasses="icon icon_size_s icon_with-text icon_settings"
                        content="Settings"/>
                </div>
                <div className="desktop_hidden">
                    <Button 
                        isIcon
                        buttonClasses="button button_primary button_icon button_size_icon" 
                        iconClasses="icon icon_size_s icon_settings"/>
                </div>
            </div>
        </div>
        <div className="main">
